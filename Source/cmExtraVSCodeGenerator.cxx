...
void cmExtraVSCodeGenerator::CreateKateProjectFile(
...
void cmExtraVSCodeGenerator::WriteTargets(const cmLocalGenerator& lg,
...
void cmExtraVSCodeGenerator::AppendTarget(cmGeneratedFileStream& fout,
...
void cmExtraVSCodeGenerator::CreateDummyKateProjectFile(
  const cmLocalGenerator& lg) const
{
  std::string filename =
...
std::string cmExtraVSCodeGenerator::GenerateFilesString(
  const cmLocalGenerator& lg) const
{
...
std::string cmExtraVSCodeGenerator::GenerateProjectName(
...
std::string cmExtraVSCodeGenerator::GetPathBasename(
  const std::string& path) const
{
