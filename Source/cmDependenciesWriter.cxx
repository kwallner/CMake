...
void cmDependenciesWriter::WriteHeader(cmGeneratedFileStream& fs,
...
void cmDependenciesWriter::WriteFooter(cmGeneratedFileStream& fs)
{
  fs << "}" << std::endl;
}

void cmDependenciesWriter::WriteLegend(cmGeneratedFileStream& fs)
{
...
void cmDependenciesWriter::WriteNode(cmGeneratedFileStream& fs,
                                 cmLinkItem const& item)
{
...
void cmDependenciesWriter::WriteConnection(cmGeneratedFileStream& fs,
